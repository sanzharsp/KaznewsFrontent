...
<CardContent/>
    ...
    Мы не пропагандируем идею а просто говорим факты а верит в них ваш — <strong>выбор</strong>.
    <strong>Так же просим не верить сразу а перепроверять данные </strong>
  </Alert>
